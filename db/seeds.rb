...
categories = [
    {
        ...
        posts: [
            {title: 'Breadth-First Search',tag_list: ['Search', 'Uninformed']},
            {title: 'Uniform Cost Search', tag_list: ['Search', 'Uninformed']},
            {title: 'Depth-First Search', tag_list: ['Search', 'Uninformed']},
            {title: 'Depth-Limited Search', tag_list: ['Search', 'Uninformed']},
            {title: 'Iterative Deepening Search', tag_list: ['Search', 'Uninformed']}
        ]
    },
    {
        title: 'Informed Search Methods',
        posts: [
            {title: 'Greedy Best-First Search', tag_list: ['Search', 'Informed']},
            {title: 'A*', tag_list: ['Search', 'Informed']}
        ]
    },
    {
        title: 'Misc',
...
categories.each do |category|
  ...
  category[:posts].each do |post|
    temp_post = Post.create!(title: post[:title], description: lorem_ipsum, body_html: post_body_html, category: temp_category, user: user)
